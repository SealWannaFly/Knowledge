## ***Устройство браузера***
Устройство браузера под капотом:
![Браузер под капотом](https://habrastorage.org/webt/dl/fr/hh/dlfrhh43eqb66arhgeic_h6e_8c.png)
...
## **Рендеринг WEB-страницы**

![Общая схема](https://y-doka.site/assets/images/posts/how-the-browser-creates-pages/____01.png)
...
***Reflow (Relayout)*** - перерасчет положени элемента, если изменения затрагивают содержимое, структуру документа, положение элементов. Причинами таких изменений обычно являются:
...
## **Что такое HTTP?**
![HTTP](https://www.clickminded.com/wp-content/uploads/client-and-server-communication-protocols.png)
...
## **Что такое Rest API?**
![Rest API](https://miro.medium.com/max/1400/1*f-4u01cDYiy6N5IRBktZnw.png)
...
## **Анализ CSS**
Когда браузер отображает документ, он ***должен совместить содержимое со стилями***. Этот процесс идёт в несколько этапов, о которых мы сейчас поговорим.
...
![Диаграмма](https://mdn.mozillademos.org/files/17080/Browser_simple_rendering_pipeline__ru.png)
...
![Группы селекторов по эффективности обработки](https://webformyself.com/wp-content/uploads/2018/294/1.jpg)
Браузеры читают CSS ***справа налево***. Самый правый селектор в составном селекторе известен как селектор key. Так, например, в #id .class > ul a, селектор key является a. 
...
## **Еще немного о Repaint и Reflow**
...
## **Свойство display - какие значения принимает и как они работают?**
Основные значения:
...
При использовании этого свойства ширина и высота будут ***включать в себя*** ***padding*** и ***border***, но не ***margin***.

## **Что такое Inline стили и какой у них приоритет?**
...
## **Что такое псевдоклассы и какие вы используете чаще всего?**
...
## **Как увеличить в размере элемент, не сдвигая соседние?**
...
## **Для чего нужны map, filter, reduce, forEach , каковы особенности использования?**
...
## **Отличие стрелочных функция от функций, объявленных через function?**
- Синтаксис
...
## **Какие способы работы с асинхронным кодом имеются?**
- ***callback*** - функция обратного вызова
- ***Promise***
- ***async/await*** - специальный синтаксис по работе с промисами

## **Для чего нужны e.preventDefault() и e.stopPropagination?**
